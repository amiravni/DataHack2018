...
if __name__ == '__main__':
    ...
    video_dir='D:\\DataHack2018\\from_shlomi\\data\\Test\\vid_42'
    ...
    for idx, frame in enumerate(data_utils.enumerate_frames(video_dir)):
        ...
        if idx%KeyFrameUpdate==0 or idx == 999:
            ...
            for idxTmp,prev_img_tmp in enumerate(prev_img_list):
                ...
                if writeLabelFlag:
                    print('saving '+str(video_dir+"\\"+fn_list[idxTmp]+"_label_pred.csv"))
